...
CLOOP   JUB    RDREC		READ INPUT RECORD
...
LENGTH 	RESW	2			REUSING LABEL
BUFFERssssss  RESB    4096		4096-BYTE BUFFER AREA
.
...
4RLOOP   TD      INPUT		TEST INPUT DEVICE
...
EXIT    STX     LENGTH		SAVE RECORD LENGTH
		RSUB               	RETURN TO CALLER
INPUT   BYTE    X'F10'		CODE FOR INPUT DEVICE
MAXLEN	WORD	4096
.
